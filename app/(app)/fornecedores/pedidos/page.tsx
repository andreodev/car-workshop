...
import { deleteSupplierOrder, fetchSupplierOrders } from "../supplier-api";
  ...
  return (
    <div className="space-y-5 rounded-md border bg-white p-6 shadow-sm">
      <header className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        <div>
          <h1 className="text-2xl font-semibold">Pedidos para fornecedores</h1>
        ...
        <div className="flex flex-col gap-2 sm:flex-row">
          ...
          <Button asChild>
            <Link href="/fornecedores/pedidos/novo">Cadastrar pedido</Link>
          </Button>
        </div>
      </header>
                ...
                <TableRow key={order.id}>
                  ...
                  <TableCell className="text-right">
                    <Button variant="ghost" size="sm" asChild>
                      <Link href={`/fornecedores/pedidos/${order.id}`}>Editar</Link>
                    </Button>
                    <Button
                      type="button"
                      variant="destructive"
